...
GlobalControls::GlobalControls(juce::AudioProcessorValueTreeState& apvts){
    ...
    inGainSlider = make_unique<RSWL>(gainInParam, "dB",
                                                  "INPUT TRIM");
    lowMidXoverSlider = make_unique<RSWL>(lowMidParam, "Hz",
                                                        "LOW-MID X-OVER");
    midHighXoverSlider = make_unique<RSWL>(midHighParam, "Hz",
                                                         "MID-HI X-OVER");
    outGainSlider = make_unique<RSWL>(gainOutParam, "dB",
                                                    "OUTPUT TRIM");
