...
GlobalControls::GlobalControls(juce::AudioProcessorValueTreeState& apvts){
    ...
    inGainSlider = make_unique<RSWL>(getParamHelper(Names::Gain_In), "dB");
    lowMidXoverSlider = make_unique<RSWL>(getParamHelper(Names::Low_Mid_Crossover_Freq), "Hz");
    midHighXoverSlider = make_unique<RSWL>(getParamHelper(Names::Mid_High_Crossover_Freq), "Hz");
    outGainSlider = make_unique<RSWL>(getParamHelper(Names::Gain_Out), "dB");
    ...
    makeAttachmentHelper(inGainSlidetrAttachment, Names::Gain_In,
                         *inGainSlider);
    
    makeAttachmentHelper(lowMidXoverSliderAttachment, Names::Low_Mid_Crossover_Freq,
                         *lowMidXoverSlider);
    
    makeAttachmentHelper(midHighXoverSliderAttachment, Names::Mid_High_Crossover_Freq,
                         *midHighXoverSlider);
    
    makeAttachmentHelper(outGainSliderAttachment, Names::Gain_Out,
                         *outGainSlider);
...
void SimpleMBCompAudioProcessorEditor::resized(){
    ...
    globalControls.setBounds(bounds.removeFromTop(225));
