...
vector<float> SpectrumAnalyzer::getGains()
{
//    return std::vector<float>
//    {
//        -24, -12, 0, 12, 24
...
vector<float> SpectrumAnalyzer::getXs(const std::vector<float> &freqs, float left, float width)
{
    std::vector<float> xs;
    for( auto f : freqs )
    {
